						...
						<div class="table-responsive">
                            ...
                            if(isset($_POST['search'])){?>
                                ...
                                <?php
                                    ...
                                    if ($stock_type == 'Expired') {
                                        $query = "SELECT * FROM stock where uid = '$uid' and manufacturer_name='$manufacturer_name' or medicine_name='$medicine_name' or date_of_expiry > sysdate()";
                                    }
                                    elseif ($stock_type == 'Available') {
                                        $query = "SELECT * FROM stock where uid = '$uid' and (manufacturer_name='$manufacturer_name' or medicine_name='$medicine_name' or date_of_expiry <= sysdate())";
                                    }
                                    else{
                                        $query = "SELECT * FROM stock where uid = '$uid' and (manufacturer_name='$manufacturer_name' or medicine_name='$medicine_name');";
                                    }
                                    $query_run = mysqli_query($con,$query);
                                $count= 0;
                                while ($row = mysqli_fetch_array($query_run)){
