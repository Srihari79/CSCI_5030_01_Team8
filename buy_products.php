						...
						<div class="table-responsive">
                            ...
                            <?php 
                                if(isset($_POST['add_stock'])){
                                    ...
                                    $query="INSERT INTO cart VALUES ('$uid','$stock_id','$selected_medicine_name','$selected_quantity','$r_value');";
                                    $query_run = mysqli_query($con,$query);
                                    if($query_run){
                            ...
                            if(isset($_POST['search'])){?>
                                ...
                                while ($row = mysqli_fetch_array($query_run)){
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="add-stock.php?a=<?php echo $uid ?>" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i>Add</a> </td>
                                    </tr>
                               <?php 
                                   }
                                    if($count == 0){
