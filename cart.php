		...
		<div class="page-wrapper">
            <div class="content">
                <div class="row">
					...
					<p><h3 class="heading"><strong>Med Life</strong></br>
            ...
            <?php
                if(isset($_POST['create'])){
                    echo '<script type ="text/javascript"> alert("We are developing a page for our customers please give us some time...")</script>';
                    // $date = date("d/m/Y");
