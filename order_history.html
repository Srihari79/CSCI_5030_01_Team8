                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table" id="bill">
                                ...
                                $query = "SELECT SUM(indiviual_cost) AS value_sum,billing_no,date from billing WHERE uid = '$uid' GROUP BY billing_no ";
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="bill.php?a=<?php echo $uid?>&b=<?php echo $bill_no?>"> View Details</a>
